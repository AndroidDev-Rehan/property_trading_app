          ...
          child: InkWell(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 20,),
                Text("Martha Craig", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,fontSize: 18 ),),
                Spacer(),
                CustomElevatedButton(text: "Files", onPressed: (){
                  pushNewScreen(
                    context,
                    screen: const ProfileTransferScreen(),
                    withNavBar: true, // OPTIONAL VALUE. True by default.
        ...
        Expanded(
          child: Chat(
            ...
            theme: const DefaultChatTheme(
              primaryColor: mainGolden,
              backgroundColor: darkMain,
              inputBackgroundColor: mainGolden,
              sendingIcon: Icon(Icons.send, color: darkMain,),
              secondaryColor: darkMain,
